document.querySelector('.banner-btn').addEventListener('click', ()=>{
    ...
    document.querySelector('.banner').getElementsByClassName.display = 'none';
...
document.querySelector('.x-btn').addEventListener('click', () => {
    ...
    document.querySelector('.container').style.background = 'linear-gradient(rgba(0, 0, 0, .8), rgba(0, 0, 0, .7)), url(images/bg2.jpeg) center no-repeat'
